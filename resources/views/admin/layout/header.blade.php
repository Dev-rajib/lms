            ...
            <div class="topbar-main  navbar m-b-0 b-0">
                <div class="container">
                    ...
                    <div class="topbar-left">
                        <a href="index-2.html" class="logo"><i class="md md-terrain"></i> <span>INVENTORY MANAGEMENT SYSTEM </span></a>
                    </div>
                    <!-- End Logo container-->
                            ...
                            <li class="dropdown user-box">
                                <a href="#" class="dropdown-toggle waves-effect waves-light profile " data-toggle="dropdown" aria-expanded="true">
                                    @if(!empty(Auth::guard('admin')->user()->image))
                                      <img src="{{url('admin/images/photos/small/'.Auth::guard('admin')->user()->image)}}" alt="Profile Image"  alt="user-img" class="img-circle user-img" />
                                     @else
                                     <img src="{{url('admin/images/no_images.png')}}" alt="Profile Image" alt="user-img" class="img-circle user-img" />
                                    @endif
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="{{url('admin/update-admin-password')}}"><i class="md md-settings"></i> Update password</a></li>
                                    <li><a href="{{url('admin/update-admin-details')}}""><i class="md md-edit"></i>Update details</a></li>
